                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                {!! Form::open(['method' => 'PATCH', 'route' => ['backend.pages.restore', $module_name_singular]]) !!}
                                    <button type="submit" class="btn btn-warning btn-sm" data-toggle="tooltip" title="{{__('labels.backend.restore')}}"><i class='fas fa-undo'></i> {{__('labels.backend.restore')}}</button>
                                {!! Form::close() !!}
